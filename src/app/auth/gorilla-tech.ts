const gorillaTech = {
  conceptsToGrips: {
    id: 0,
    name: 'conceptsToGrips',
    displayName: 'Concepts To Grips',
    prevTechnique: null,
    nextTechnique: 'standingCollarGrips',
    quiz: {
      complete: false,
  ...
  standingCollarGrips: {
    id: 1,
    name: 'standingCollarGrips',
    displayName: 'Standing Collar Grips',
    prevTechnique: 'conceptsToGrips',
    ...
    notes: [
      {
        text: 'Undersleeve taco grip and fatty palm to palm, take the slack out of lapel before breaking',
      },
      {
        text: 'Fish the lapel then reach under your opponents mirror grip with your own mirror grip',
      },
      {
        text: 'Push his hand up and use the top of your head under his arm and stand up tall',
      },
      {
        text: 'Double shelf grip on one sleeve and roll the knuckles into their arm',
      },
    ],
    video: {
